Public Class Cita
    ...
    Public Sub New(num_expediente As Integer, idCita As Integer, idEmpleado As Integer, idExamen As Integer, idMedico As Integer, fecha_visita As Date, horario As String)
